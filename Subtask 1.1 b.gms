...
equations
*variablecosts usage costs
*fixedcosts construction cots
...
put "from " j.tl:8 " to " i.tl:8 ( sum(u, x1.L(u,j,i)) ):6:0 /;
);
...
put "from " j.tl:8 " to " i.tl:8 ( sum(u, x2.L(u,j,i)) ):6:0 /;
);
...
put "from " j.tl:8 " to " i.tl:8 ( sum(u, x3.L(u,j,i)) ):6:0 /;
);
