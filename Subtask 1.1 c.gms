...
*code for origin-related traffic flow for node 15
...
loop((u, i, j)$(ord(u) = 15 and x.l(u, i, j) > 0),
    put '\draw[->, thick] (' i.tl ') to node[fill=white, font=\scriptsize] {' x.l(u, i, j):6:0 '} (' j.tl ');' /;
);
