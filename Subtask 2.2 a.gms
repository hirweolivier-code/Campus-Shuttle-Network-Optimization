...
loop (EL(l,i,j),
         ...
         d(l,i,j) = 8 + sum((p,u,v)$(LPV(l,p,u) and LPV(l,p+1,v) and ord(p) >= be and ord(p) < en), dE(u,v)) ;
);
...
*Declaration and definition of the sets ed and edl
 ...
 N8.N14,N9.N32, N10.N21,   N10.N22, N10.N26,  N10.N29, N11.N24, N12.N13, N12.N14,  N13.N15,  N13.N23,   N13.N24,    N15.N24, N16.N31 , N17.N24,  N17.N26,   N17.N30,
